...
module.exports.tasks = [
  { id: "1", name: "Work", completed: false, userId: ["3", "1"] },
  { id: "2", name: "Eat", completed: true, userId: ["1", "2"] },
  { id: "3", name: "Shopping", completed: true, userId: ["1", "4"] },
  { id: "4", name: "Gym", completed: true, userId: ["1", "2"] },
];
